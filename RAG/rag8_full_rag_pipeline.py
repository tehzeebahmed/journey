...
This is an extention to the rag7 script with few additioons as while loop:
...
def query_knowledge_base(collection: chromadb.Collection, question: str, top_k: int, threshold=0.5):
...
# You now have a working BFSI policy assistant that:

# Reads a real document from disk
# Chunks and indexes it once
# Answers multiple questions from the same index
# Filters irrelevant chunks by distance
# Refuses out-of-domain questions cleanly
# Falls back across LLM providers automatically