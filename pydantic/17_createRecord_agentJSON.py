...
#what this class does is it defines a schema for the input data that the tool will receive. 
# It uses Pydantic's BaseModel to create a structured model for the customer input, 
# which includes fields for name, city, age, and country, each with a description. 
# This allows for validation and clear documentation of the expected input when the tool is called.
    name: str = Field(
