...
class StudentRegistration(BaseModel):
    student_id: str = Field(
        ...
        #in format STD001₹, STD002₹, etc., which is automatically generated using the uuid library. 
        ...
        # explaination: This field is a unique identifier for the student, in format STD001₹, STD002₹, etc., which is automatically generated using the uuid library. 
        # The default_factory parameter is used to specify that a new UUID should be generated each time a new instance of the StudentRegistration model is created.
